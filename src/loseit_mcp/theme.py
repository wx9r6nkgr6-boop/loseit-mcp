...
def css(theme):
    ...
    [data-testid="stMetricValue"] {{font-weight:850;color:var(--accentSecondary);font-variant-numeric:tabular-nums;}}
    ...
    [data-testid="stExpander"],[data-testid="stDataFrame"] {{border-radius:var(--radius);border-color:var(--border);}}
